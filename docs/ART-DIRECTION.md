...
The initial game view should be isometric or near-isometric.

Priorities:

- readable silhouettes
- clean navigation spaces
- layered verticality
...
Reference art may be added later under a dedicated reference directory, such as:

```text
references/art/
```

For now, this document defines the intended language in words so implementation can begin without blocking on asset organization.

When image references are added, they should be treated as directional references rather than strict final assets unless explicitly marked otherwise.
